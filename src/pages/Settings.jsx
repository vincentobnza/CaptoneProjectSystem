      ...
      <div className="w-full mt-5 flex flex-col space-y-6">
        ...
        <div className="w-full flex justify-between">
          <div className="basis-1/4 flex flex-col gap-2">
            <div className="size-20 grid place-items-center cursor-pointer border border-zinc-100 rounded-full overflow-hidden">
              <img
          ...
          <div className="basis-3/4 flex flex-col items-start gap-2">
            ...
            />
            <p className="text-zinc-800 font-medium text-sm">First Name</p>
            <input
              type="text"
              className="w-full border border-zinc-200 rounded-lg p-3 text-zinc-700 mb-5 outline-none hover:border hover:border-zinc-400 duration-700 transition-all ease-in-out"
            ...
            <p className="text-zinc-800 font-medium text-sm">Last Name</p>
            <input
              type="text"
              className="w-full border border-zinc-200 rounded-lg p-3 text-zinc-700 mb-5 outline-none hover:border hover:border-zinc-400 duration-700 transition-all ease-in-out"
